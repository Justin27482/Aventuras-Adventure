<script lang="ts">
  ...
  import ColorPicker from '$lib/components/vault/prompts/ColorPicker.svelte'
...
<div class="space-y-4">
  ...
  <!-- Reading Window Formatting -->
  <div class="space-y-3 rounded-lg border p-3">
    <div>
      <Label>Reading Window Formatting</Label>
      <p class="text-muted-foreground text-xs">
        Customize the colors used for quoted text, italics, bold text, and angle-bracket text.
      </p>
    </div>

    <div class="grid gap-3 sm:grid-cols-2">
      <div class="flex items-center justify-between gap-3">
        <Label class="text-sm font-normal">Main text</Label>
        <ColorPicker
          value={settings.uiSettings.readingWindowFormatting.mainText}
          onChange={(color) => void settings.setReadingWindowFormatting({ mainText: color })}
        />
      </div>

      <div class="flex items-center justify-between gap-3">
        <Label class="text-sm font-normal">Italics text</Label>
        <ColorPicker
          value={settings.uiSettings.readingWindowFormatting.italicsText}
          onChange={(color) => void settings.setReadingWindowFormatting({ italicsText: color })}
        />
      </div>
      ...
      <div class="flex items-center justify-between gap-3">
        <Label class="text-sm font-normal">Quoted text</Label>
        <ColorPicker
          value={settings.uiSettings.readingWindowFormatting.quoteText}
          onChange={(color) => void settings.setReadingWindowFormatting({ quoteText: color })}
        />
      </div>
