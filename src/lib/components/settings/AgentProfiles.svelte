<script lang="ts">
  ...
  const systemServices = [
    ...
    // Memory & Context tasks
    {
      ...
      label: 'Memory System',
      icon: Brain,
      description: 'Analyzes sessions and campaign context',
    },
    {
      id: 'chapterQuery',
      label: 'Session Query',
      icon: Search,
      description: 'Queries session details',
    },
    {
      id: 'timelineFill',
      label: 'Timeline Fill',
    ...
    },
    {
      ...
      icon: Shield,
      description: 'Rewrites or suppresses invalid secret reveals',
    },
    {
      id: 'styleReviewer',
    ...
    {
      id: 'directorOutliningAssistant',
      label: 'Director Assistant',
      icon: Shield,
      description: 'Interactive campaign planning and outlining assistant',
    },
    {
      id: 'editorAssistant',
      label: 'Editor Assistant',
      icon: Pencil,
      description: 'Interactive draft critique and rewrite assistant',
    },
    // Wizard tasks
    {
      ...
      icon: Wand2,
      description: 'Expands campaign settings',
    },
    {
      id: 'wizard:settingRefinement',
      label: 'Setting Refinement',
      icon: Wand2,
      description: 'Refines campaign settings',
    },
    {
      id: 'wizard:protagonistGeneration',
      label: 'Lead Character Gen',
      icon: Wand2,
      description: 'Generates lead characters',
    },
    {
