    ...
    <div class="min-h-0 flex-1 overflow-y-auto p-4">
      ...
      {:else if wizard.currentStep === 2}
        <StepUploadFiles
          ...
          onChatFileProcess={(text: string) => void wizard.processChatFile(text)}
      ...
      {:else if wizard.currentStep === 4}
        <StepImportCharacters
          ...
          onSetAsProtagonist={(i) => wizard.setSupportingCharacterAsProtagonist(i)}
      ...
      {:else if wizard.currentStep === 6}
        <StepImportStyle
          ...
          detectedPOV={wizard.detectedPOV}
          detectedTense={wizard.detectedTense}
          styleDetectionConfidence={wizard.styleDetectionConfidence}
          styleDetectionRationale={wizard.styleDetectionRationale}
          isDetectingStyle={wizard.isDetectingStyle}
          styleDetectionError={wizard.styleDetectionError}
          enableStyleRewritePass={wizard.enableStyleRewritePass}
          enableCreativeCleanupPass={wizard.enableCreativeCleanupPass}
          onModeChange={(v) => (wizard.selectedMode = v)}
          onPOVChange={(v) => wizard.setSelectedPOV(v)}
          onTenseChange={(v) => wizard.setSelectedTense(v)}
          ...
          onStyleRewritePassChange={(v) => wizard.setEnableStyleRewritePass(v)}
          onCreativeCleanupPassChange={(v) => wizard.setEnableCreativeCleanupPass(v)}
        />
      ...
      {:else if wizard.currentStep === 8}
        <StepImportReview
          ...
          importProcessingStatus={wizard.importProcessingStatus}
          importProcessingProgress={wizard.importProcessingProgress}
          chapterizationReport={story.chapterizationReport}
          chapterizationAwaitingDecision={story.chapterizationAwaitingDecision}
          ...
          onContinueChapterization={() => story.continueGuidedChapterization()}
          onAbortChapterization={() => story.abortGuidedChapterization()}
        />
      {/if}
    </div>
