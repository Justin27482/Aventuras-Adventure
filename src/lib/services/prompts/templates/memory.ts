...
const interactiveLorebookGreetingPromptTemplate: PromptTemplate = {
  id: 'interactive-lorebook-greeting',
  name: 'Interactive Lorebook Greeting',
  category: 'service',
  description: 'Initial assistant greeting shown when starting a new vault assistant conversation',
  content: `{% if entityName != '' %}Hello! I can see you were editing the {{ entityType }} **{{ entityName }}**. What would you like to work on?{% else %}Hello! I'm your Vault Assistant. I can help you manage characters, lorebooks, and scenarios in your vault.

Try asking me to create a character, organize lorebook entries, or set up a new scenario.{% endif %}`,
}
...
export const memoryTemplates: PromptTemplate[] = [
  ...
  interactiveLorebookGreetingPromptTemplate,
