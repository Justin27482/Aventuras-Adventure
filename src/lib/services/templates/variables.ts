...
export const RUNTIME_VARIABLES: VariableDefinition[] = [
  // === AI Player Prompts ===
  ...[
    ['aiPlayerName', 'AI Player profile name'],
    ['aiPlayerCharacterName', 'Assigned character name'],
    ['aiPlayerProfileContext', 'Structured personality, assignment, scene, and knowledge context'],
    ['aiPlayerDecisionPrompt', 'Rendered AI Player decision and participation contract'],
    ['aiPlayerPrompt', 'Complete rendered AI Player system prompt'],
    ['aiPlayerSceneGoal', 'Current goal supplied for the AI Player turn'],
    ['aiPlayerTargetLength', 'Target response length guidance for the AI Player turn'],
    ['aiPlayerImmersion', 'Immersion level of this AI Player, from 0 to 10'],
    ['aiPlayerArousal', 'Arousal level of this AI Player, from 0 to 10'],
    ['aiPlayerRecentActions', 'Recent actions visible to the AI Player'],
    ['aiPlayerVisibleSecrets', 'Private knowledge visible to the AI Player'],
    ['aiPlayerMemories', "Campaign-gated recall of the AI Player's own past experiences"],
    ['aiPlayerVoiceProfile', 'Full authored and structured voice profile for one AI Player'],
    ['aiPlayerVoicePrompt', 'Rendered distinct-voice contract for the current AI Player'],
    ['otherAIPlayerVoices', 'Concise voice profiles for other AI Players at the table'],
    ['priorAIPlayerMessages', 'Earlier AI Player messages whose phrasing should not be mirrored'],
    ['aiPlayerCoreMotivation', 'AI Player core motivation'],
    ['aiPlayerPlaystyle', 'AI Player preferred play style'],
    ['aiPlayerDecisionSpeed', 'AI Player decision-making speed'],
    ['aiPlayerHumorStyle', 'AI Player humor style'],
    ['gmTableMessage', 'Latest GM-authored Table Talk message'],
    ['tableTalkCandidates', 'AI Players eligible to respond in Table Talk'],
    ['recentTableTalkTranscript', 'Recent out-of-character table transcript'],
    ['maximumResponders', 'Maximum AI Players that may respond'],
    ['tableTalkPlayerName', 'AI Player profile name speaking in Table Talk'],
    ['tableTalkCharacterName', 'Character or table identity used in Table Talk'],
    ['tableTalkPlaystyle', 'Speaking AI Player play style'],
    ['recentAction', 'Recent action or event prompting a response'],
    ['otherTableParticipants', 'Other participants present at the table'],
    ['tableTalkIntensityLabel', 'Human-readable Table Talk intensity'],
    ['tableTalkIntensity', 'Numeric Table Talk intensity'],
    ['campaignPremise', 'Campaign premise discussed during Session Zero'],
    ['consensusCurrentAction', 'Current AI Player action under discussion'],
    ['consensusOtherProposals', 'Other included AI Player proposals'],
    ['worldbuildingDraft', 'Current structured worldbuilding form'],
    ['worldbuildingConversation', 'Current worldbuilding conversation history'],
    ['worldbuildingUserMessage', 'Latest worldbuilding user message'],
    ['worldbuildingCharter', 'Current world charter markdown'],
    ['characterCreationWorldContext', 'Campaign premise, world charter, and setting context'],
    ['characterCreationRuleset', 'Ruleset fields and limits for character creation'],
    ['characterCreationGuidance', 'GM guidance for the proposed character'],
  ...
  // === Narrative Helper ===
  {
    name: 'narrativeHelperOperation',
    type: 'text',
    category: 'runtime',
    description: 'Narrative helper operation: expand or regenerate',
    required: false,
  },
  {
    name: 'summary',
    type: 'text',
    category: 'runtime',
    description: 'GM-authored summary to polish',
    required: false,
  },
  {
    name: 'sceneSummary',
    type: 'text',
    category: 'runtime',
    description: 'Current scene context for narrative polishing',
    required: false,
  },
  {
    name: 'audience',
    type: 'text',
    category: 'runtime',
    description: 'Intended audience for the generated narration',
    required: false,
  },
  {
    name: 'mood',
    type: 'text',
    category: 'runtime',
    description: 'Requested mood for the generated narration',
    required: false,
  },
  {
    name: 'includeFactCheck',
    type: 'boolean',
    category: 'runtime',
    description: 'Whether the narrative helper should include fact checking',
    required: false,
  },
  {
    name: 'previousNarration',
    type: 'text',
    category: 'runtime',
    description: 'Previous narrative-helper draft when regenerating',
    required: false,
  },

  // === Private Prologue Memory ===
  {
    name: 'privatePrologueTranscript',
    type: 'text',
    category: 'runtime',
    description: 'Completed private prologue chat transcript to summarize into AI Player memory',
    required: false,
  },
  ...
  },
  {
    ...
    type: 'text',
    category: 'runtime',
    description: 'Current structured appearance text for the Appearance Assistant',
    required: false,
  },
  {
    name: 'appearanceGuidance',
    type: 'text',
    category: 'runtime',
    description: 'Optional user guidance for the Appearance Assistant',
    required: false,
  },
  {
    name: 'appearanceDescriptorLabels',
    type: 'text',
    category: 'runtime',
    description: 'Comma-separated descriptor labels available to the Appearance Assistant',
    required: false,
  },
  {
